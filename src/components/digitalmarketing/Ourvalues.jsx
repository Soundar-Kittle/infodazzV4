  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="text-center mb-12">
        <p className="text-green-600 text-sm font-medium uppercase tracking-wide">Why Us</p>
        ...
        <ul className="space-y-12 relative z-10">
          {values.map((item, idx) => {
            ...
            >
              ...
              {/* Card */}
              <div
                className={`relative w-full md:w-[46%] px-6 py-6 bg-white border border-gray-300 shadow rounded`}
              >
                {/* Arrow Pointer */}
                <div
